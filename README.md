...
# 🎮 Shao Song I — Community Edition

**Shao Song I — standalone Community Edition, ready to play.**
...
Shao Song I is an action-adventure game featuring stylized combat, exploration, and character progression set in an eastern-inspired world. This Community Edition is a standalone build distributed as a self-contained package. It requires no storefront or additional software, and includes all content ready to play immediately after installation.

This build is intended for PC players who want a complete, offline, single-purchase-free standalone release of Shao Song I.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4292950/038d85a0ce5ff1a3f32b6860f09dd39be8107e99/ss_038d85a0ce5ff1a3f32b6860f09dd39be8107e99.1920x1080.jpg?t=1788157420" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4292950/3841ad58f10337f6576c209e5b66622d6eab0a5e/ss_3841ad58f10337f6576c209e5b66622d6eab0a5e.1920x1080.jpg?t=1788157420" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4292950/938f9280c474e153450280c2115816043af5d141/ss_938f9280c474e153450280c2115816043af5d141.1920x1080.jpg?t=1788157420" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- ⚔️ **Action Combat** — Responsive melee combat with varied weapon handling and enemy patterns.
- 🗺️ **Exploration** — Traverse interconnected environments with hidden paths and collectibles.
- 📈 **Progression System** — Upgrade abilities and equipment as you advance through the campaign.
- 🎨 **Stylized Art Direction** — Distinct visual presentation inspired by eastern aesthetics.
- 🎼 **Original Soundtrack** — Ambient and thematic score accompanying exploration and combat.
- 💾 **Self-Contained Package** — All necessary components included; no additional downloads required.
- 🔌 **Offline Play** — Runs fully offline with no account or storefront login needed.
- 🖥️ **Light System Footprint** — Runs smoothly on a wide range of common PC hardware.
...
- None — base game includes all content
...
| **RAM** | 4 GB | 8 GB |
| **Graphics** | NVIDIA GeForce GTX 750 Ti / AMD Radeon RX 550 | NVIDIA GeForce GTX 1050 Ti / AMD Radeon RX 570 |
| **Storage** | 10 GB available space | 10 GB available space on SSD |
| **Additional** | DirectX 11 compatible hardware | DirectX 11 compatible hardware, audio output device |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\ShaoSongI\Saved`
